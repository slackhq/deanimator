// A modified version of golang 1.18's image/gif/reader.go
// Only reads the first frame of a gif
// Also includes patch from https://go-review.googlesource.com/c/go/+/329329
package parser
